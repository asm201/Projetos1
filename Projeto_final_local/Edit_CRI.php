...
<meta charset="UTF-8">
    ...
    <div class="box_edit_cri">
        <form action="saveEdit_CRI.php" id="saveEdit_CRI" method="post">
            <fieldset>
                ...
                <input type="radio" id="Certidão_SIM" name="Certidao_pessoa" value="SIM" <?php echo $Certidao_pessoa == "SIM" ?"checked":"" ?>>
                <label for="Certidão_SIM">Sim</label>
                <input type="radio" id="Certidão_NÃO" name="Certidao_pessoa" value="NÃO" <?php echo $Certidao_pessoa == "NÃO" ?"checked":"" ?>>
                <label for="Certidão_NÂO">Não</label>
                <input type="radio" id="Certidão_COP" name="Certidao_pessoa" value="COP" <?php echo $Certidao_pessoa == "COP" ?"checked":"" ?>>
                <label for="Certidão_COP">Possui cópia</label>
                <input type="radio" id="Certidão_NAS" name="Certidao_pessoa" value="NAS" <?php echo $Certidao_pessoa == "NAS" ?"checked":"" ?>>
                ...
                <div class="field radiobox"> 
                    ...
                    <input type="radio" id="Mãe_Viva_Sim" name="Mãe_Viva" value="SIM" <?php echo $Mae_pessoa == "SIM" ?"checked":"" ?> onclick="Requerido('Mãe_Pessoa');Requerido('Mãe_Pessoa_Endereco')" >
                    <label for="Mãe_Viva_Sim">Sim</label>
                    <input type="radio" id="Mãe_Viva_NÃO" name="Mãe_Viva" value="NÃO" <?php echo $Mae_pessoa == "NÃO" ?"checked":"" ?> onclick="Limpar('Mãe_Pessoa');Limpar('Mãe_Pessoa_Endereco')" >
                    <label for="Mãe_Viva_Não">Não</label>
                    <input type="text"  name="Text_Mae_Viva" id="Mãe_Pessoa" style="display:none"  class="inputUser" value="<?php echo $Nome_mae_pessoa ?>"  placeholder="Digite o Nome da Mãe caso viva:" required/>
                    <!---Verificar se funfa qualquer coisa muda no Bd para que posssa ser null--->
                    <br><br>
                    <input type="text"  name="Text_Residencia_Mae_Pessoa" id="Mãe_Pessoa_Endereco" style="display:none"  class="inputUser" value="<?php echo $Text_Residencia_Mae_Pessoa ?>"  placeholder="Digite a Residência da Mãe:" required/>
                    <!---Verificar se funfa qualquer coisa muda no Bd para que posssa ser null--->
                ...
                <div class="field radiobox">            
                    ...
                    <input type="radio" id="Pai_Viva_Sim" name="Pai_Vivo" value="SIM" <?php echo $Pai_pessoa == "SIM" ?"checked":"" ?> onclick="Requerido('Pai_Pessoa');Requerido('Pai_Pessoa_Endereco')" >
                    <label for="Pai_Viva_Sim">Sim</label>
                    <input type="radio" id="Pai_Viva_NÃO" name="Pai_Vivo" value="NÃO" <?php echo $Pai_pessoa == "NÃO" ?"checked":"" ?> onclick="Limpar('Pai_Pessoa');Limpar('Pai_Pessoa_Endereco')" >
                    <label for="Pai_Viva_Não">Não</label>
                    <input type="text"  name="Text_Pai_Vivo" id="Pai_Pessoa" style="display:none" class="inputUser" value="<?php echo $Nome_pai_pessoa ?>"  placeholder="Digite o Nome do Pai caso vivo:" required/>
                    <br><br>
                    <input type="text"  name="Text_Residencia_Pai_Pessoa" id="Pai_Pessoa_Endereco" style="display:none"  class="inputUser" value="<?php echo $Text_Residencia_Pai_Pessoa ?>"  placeholder="Digite a Residência do Pai:"required/>
    ...
    <script src="js/script_Update_CRI.js"></script>
</body>
</html>