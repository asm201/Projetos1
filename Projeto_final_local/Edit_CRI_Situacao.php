<?php
    ...
    if(!empty($_GET['Documento']))
    {
        ...
        if($result->num_rows > 0){
            ...
            while($user_data = mysqli_fetch_assoc($result)){
                ...
                $Txt_Permancer_Pessoa      = $user_data['Permanencia'];
    ...
    <meta charset="UTF-8">
        <div class="box_CRI_Situacao">
            <form action="saveEdit_CRI_Situacao.php" id="saveEdit_CRI_Situacao" method="post">
                <fieldset>
                    ...
                    <div class="field radiobox">
                        ...
                        <br><br>
                        <textarea type="text" name="Txt_Situacao_Pessoa" id="Txt_Situacao_Pessoa" style="display:none" placeholder="Digite aqui" class="inputUser" ><?php echo $Situacao_Pessoa ?></textarea>
                        <?php echo $Situacao_Pessoa != "N/A" ?"<script>Preencher('Txt_Situacao_Pessoa')</script>":""  ?>
                    </div>
                    <br>
                    ...
                    <div class="field radiobox">
                        ...
                        <br><br>
                        <textarea type="text" name="Txt_Alguem_Pessoa" id="Txt_Alguem_Pessoa" style="display:none" placeholder="Digite aqui" class="inputUser" ><?php echo $Txt_Alguem_Pessoa ?></textarea>
                    ...
                    <div class="field radiobox">
                        ...
                        <br><br>
                        <textarea type="text" name="Txt_Viagem_Pessoa" id="Txt_Viagem_Pessoa" style="display:none" placeholder="Digite aqui" class="inputUser" ><?php echo $Txt_Viagem_Pessoa ?></textarea>
                    ...
                    <div class="field radiobox">
                        ...
                        <input type="radio" name="Permancer_Pessoa" id="Permancer_Pessoa_Sim" value="Sim" <?php echo $Txt_Permancer_Pessoa == "N/A" ?"checked":"" ?> onclick="Limpar('Txt_Permancer_Pessoa')"><label for="Sim">Sim </label>
                        <input type="radio" name="Permancer_Pessoa" id="Permancer_Pessoa_Nao" value="Não" <?php echo $Txt_Permancer_Pessoa != "N/A" ?"checked":"" ?> onclick="Requerido('Txt_Permancer_Pessoa')"><label for="Não">Não </label>
                        <br><br>
                        <textarea type="text" name="Txt_Permancer_Pessoa" id="Txt_Permancer_Pessoa" style="display:none" placeholder="Digite aqui" class="inputUser" ><?php echo $Txt_Permancer_Pessoa ?></textarea>
                        <?php echo $Txt_Permancer_Pessoa != "N/A" ?"<script>Preencher('Txt_Permancer_Pessoa')</script>":"" ?>  
                     </div>
                    <br>
                    ...
                    <label>Possíveis necessidades de proteção da criança ou adolescente:</label><br>
                        <input type="radio" name="Proteção_Indicadores" id="Convivencia_Proteção" value="ProteçãoC" <?php echo $Proteção_Indicadores == "ProteçãoC" ?"checked":"" ?> onclick="Limpar('Txt_Protecao_Indicadores')"><label for="Convivencia_Proteção" style="text-align: justify;" required>Retorno à convivência familiar, conforme parâmetros de proteção integral e atenção ao interesse superior da criança; </label><br>
                        <input type="radio" name="Proteção_Indicadores" id="Familiar_Proteção" value="ProteçãoF" <?php echo $Proteção_Indicadores == "ProteçãoF" ?"checked":"" ?> onclick="Limpar('Txt_Protecao_Indicadores')"><label for="Familiar_Proteção" style="text-align: justify;" required>Medida de proteção por reunião familiar </label><br>
                        <input type="radio" name="Proteção_Indicadores" id="Trafico_Proteção" value="ProteçãoT" <?php echo $Proteção_Indicadores == "ProteçãoT" ?"checked":"" ?> onclick="Limpar('Txt_Protecao_Indicadores')"><label for="Trafico_Proteção" style="text-align: justify;"  required>Proteção como vítima de tráfico de pessoas; </label><br>
                        <input type="radio" name="Proteção_Indicadores" id="Outro_Proteção" value="ProteçãoO" <?php echo $Proteção_Indicadores == "ProteçãoO" ?"checked":"" ?> onclick="Requerido('Txt_Protecao_Indicadores')"><label for="Outro_Proteção" style="text-align: justify;"  required>Outra medida de regularização migratória ou proteção como refugiado ou apátrida, conforme a legislação em vigor. Informe: </label><br><br>
                        <input type="text" name="Txt_Protecao_Indicadores" id="Txt_Protecao_Indicadores" style="display:none"  placeholder="Digite aqui" class="inputUser"><?php echo $Txt_Protecao_Indicadores ?></input>
                        <?php echo $Proteção_Indicadores != "ProteçãoO" ?"<script>Limpar('Txt_Protecao_Indicadores')</script>":"" ?> 
                    </div>
                    <br>
                    <div class="field radiobox">  
