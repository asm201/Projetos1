            ...
            <form action="saveEdit_CRI_Situacao.php" id="saveEdit_CRI_Situacao" method="post">
                <fieldset>
                    ...
                    <label>Possíveis necessidades de proteção da criança ou adolescente:</label><br>
                        <input type="radio" name="Proteção_Indicadores" id="Convivencia_Proteção" value="ProteçãoC" <?php echo $Proteção_Indicadores == "ProteçãoC" ?"checked":"" ?> onclick="Limpar('Txt_Protecao_Indicadores')"><label for="Convivencia_Proteção" required>Retorno à convivência familiar, conforme parâmetros de proteção integral e atenção ao interesse superior da criança; </label><br>
                        <input type="radio" name="Proteção_Indicadores" id="Familiar_Proteção" value="ProteçãoF" <?php echo $Proteção_Indicadores == "ProteçãoF" ?"checked":"" ?> onclick="Limpar('Txt_Protecao_Indicadores')"><label for="Familiar_Proteção" required>Medida de proteção por reunião familiar </label><br>
                        <input type="radio" name="Proteção_Indicadores" id="Trafico_Proteção" value="ProteçãoT" <?php echo $Proteção_Indicadores == "ProteçãoT" ?"checked":"" ?> onclick="Limpar('Txt_Protecao_Indicadores')"><label for="Trafico_Proteção" required>Proteção como vítima de tráfico de pessoas; </label><br>
                        <input type="radio" name="Proteção_Indicadores" id="Outro_Proteção" value="ProteçãoO" <?php echo $Proteção_Indicadores == "ProteçãoO" ?"checked":"" ?> onclick="Requerido('Txt_Protecao_Indicadores')"><label for="Outro_Proteção" required>Outra medida de regularização migratória ou proteção como refugiado ou apátrida, conforme a legislação em vigor. Informe: </label><br><br>
