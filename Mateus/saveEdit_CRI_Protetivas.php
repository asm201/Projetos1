...
if(isset($_POST['update'])){
        ...
        include_once('config.php');
                ...
                $idDocumentos                   = isset($_POST['id_Doc']) ? $_POST['id_Doc'] :  null;
        ...
        $requiredFields = [
            ...
            'Gênero não preenchido' => $Gênero_Protetivas,
        ...
        foreach ($requiredFields as $field => $fieldValue) {
            ...
            Nome_Inst='$Instituicao_Protetivas',
            ...
            Descricao = '$Documento_Protetivas',
            Numero = '$Numero_Documento_Protetivas',
            Nome_Documento = '$Text_Outro_Documento_Protetivas'

            
            WHERE idDocumentos=$idDocumentos";
            var_dump($sqlUpdateDocumento);
        
            $result = $conexao->query($sqlUpdateDocumento);
