<?php
    ...
    if(!empty($_GET['Documento']))
    {
        ...
        on medidas_protetivas.Criança = ca.Documento WHERE ca.Documento=$Identidade_Pessoa";
        ...
        if($result->num_rows > 0){
            ...
            while($user_data = mysqli_fetch_assoc($result)){
                ...
                $Endereco_Inst_Protetivas               = $user_data['Endereço_Inst'];
                ...
                $Responsavel_Endereco_Protetivas        = $user_data['Endereço_respo'];
