        ...
        <form action="saveEdit_CRI.php" method="post">
            <fieldset>
                ...
                <div class="field radiobox"> 
                    <p><label style="color:#FF0000">*</label>Alguma situacão forcou você a sair do seu país de origem?</p>
                ...
                <p>Possíveis necessidades de proteção da criança ou adolescente:</p>
                    <input type="radio" name="Proteção_Indicadores" id="Convivencia_Proteção" value="ProteçãoC" <?php echo $Proteção_Indicadores == "ProteçãoC" ?"checked":"" ?> onclick="Sumir('Txt_Protecao_Indicadores')"><label for="Convivencia_Proteção" required>Retorno à convivência familiar, conforme parâmetros de proteção integral e atenção ao interesse superior da criança e do adolescente; </label><br>
                    <input type="radio" name="Proteção_Indicadores" id="Familiar_Proteção" value="ProteçãoF" <?php echo $Proteção_Indicadores == "ProteçãoF" ?"checked":"" ?> onclick="Sumir('Txt_Protecao_Indicadores')"><label for="Familiar_Proteção" required>Medida de proteção por reunião familiar </label><br>
                    <input type="radio" name="Proteção_Indicadores" id="Trafico_Proteção" value="ProteçãoT" <?php echo $Proteção_Indicadores == "ProteçãoT" ?"checked":"" ?> onclick="Sumir('Txt_Protecao_Indicadores')"><label for="Trafico_Proteção" required>Proteção como vítima de tráfico de pessoas; </label><br>
                    <input type="radio" name="Proteção_Indicadores" id="Outro_Proteção" value="ProteçãoO" <?php echo $Proteção_Indicadores == "ProteçãoO" ?"checked":"" ?> onclick="Preencher('Txt_Protecao_Indicadores')"><label for="Outro_Proteção" required>Outra medida de regularização migratória ou proteção como refugiado ou apátrida, conforme a legislação em vigor. Informe: </label><br><br>
                    ...
                    <?php echo $Proteção_Indicadores == "ProteçãoO" ?"<script>Preencher('Txt_Protecao_Indicadores')</script>":"" ?> 
                </div>
                <br>
                <div class="field radiobox">  
