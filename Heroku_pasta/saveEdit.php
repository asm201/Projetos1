<?php
    ...
    if(isset($_POST['update'])){
        ...
        $sqlUpdate = "UPDATE defensor SET Nome_Def='$Nome_Defensor',Doc_Defensor='$Documento_defensor',Cargo='$Cargo_Defensor',Endereco_Def='$Endereco_defensor',Cidade_UF='$Cidade_defensor',Telefone_Def='$Telefone_defensor',Contato_Def='$Email_defensor' 
