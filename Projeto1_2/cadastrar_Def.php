    ...
    <meta charset="UTF-8">
        <div class="box">
                <fieldset>
                    ...
                    <form action="cadastrar_Def.php" id="cadastrar_Def" method="post">
                        <div class="Container" name="Form_Defensor" name="Form_Defensor" id="Form_Defensor" style="display:none" class="inputUser">
                                ...
                                <div class="inputBox">
                                    <input type="text" name="Cidade/UF_Defensor"id="Cidade_UF_Defensor" class="inputUser" required>
                    ...
                    <form action="cadastrar_Def.php" id="cadastrar_Int" method="post">
                        <div class="Container" name="Form_Interprete" name="Form_Interprete" id="Form_Interprete" style="display:none" class="inputUser">
                                ...
                                <br><br>
                                <div class="inputBox">
                                    <input type="text" name="Telefone_Interprete" id="Telefone_Interprete" class="inputUser" required>
