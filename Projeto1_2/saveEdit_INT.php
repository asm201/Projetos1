<?php
    ...
    $sqlUpdate = "UPDATE intérprete SET Nome='$Nome_Interprete',Doc_Interprete='$Documento_Interprete',Endereço_Int='$Endereço_Interprete',Telefone_int='$Telefone_Interprete',Contato_Int='$email_Interprete' 
