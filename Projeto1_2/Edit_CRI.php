    ...
    if(!empty($_GET['Documento']))
    {
        ...
        if($result->num_rows > 0){
            ...
            while($user_data = mysqli_fetch_assoc($result)){
                ...
                $Endereco_Antigo_Pessoa         = $user_data['Endereço_origem'];
                $Endereco_atual_pessoa          = $user_data['Endereço_atual'];
                $Telefone_pessoa                = $user_data['Telefone_criança'];
                $Email_pessoa                   = $user_data['Email_Crianca'];
                $Identidade_pessoa              = $user_data['Documento'];
                $Passaporte_pessoa              = $user_data['Passaporte'];
                $Certidao_pessoa                = $user_data['Certidão_de_Nascimento'];
